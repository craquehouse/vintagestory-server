...
**Completing work - AAR REQUIRED:**
```bash
# 1. Add AAR comment BEFORE closing (mandatory)
...
**Note:** Use abbreviated AAR for size-s, full AAR for size-m/l. See CLAUDE.md or `.claude/skills/beads/SKILL.md` lines 144-282 for templates.
