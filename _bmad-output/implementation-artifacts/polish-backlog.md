...
| API-015 | Move get_server_service() singleton from routers/server.py to services/server.py                                                  | low                | S                            | done | -         | Layer separation - mods.py does this correctly                                                   |
...
| API-015                                                              | Move get_server_service() singleton from routers/server.py to services/server.py                        | 2026-01-01 | Layer separation - follows mods.py pattern                                |
