...
| UI-005                                                               | The server console tab should have ways to also "tail" *.log logfiles in serverdata/Logs                | 2026-01-01 | Added source selector dropdown in ConsolePanel, streaming via WebSocket   |
| API-006                                                              | API should be able to stream/tail *.log logfiles in serverdata/Logs                                     | 2026-01-01 | Added GET /console/logs + WebSocket /console/logs/ws                      |
