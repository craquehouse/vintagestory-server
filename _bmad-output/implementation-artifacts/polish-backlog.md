...
| ~~UI-003~~  | ~~Vertical order, top to bottom, of sidebar items should be "Dashboard", "GameServer", "Mods", "Settings"~~    | ~~low~~        | ~~S~~        | done  | ~~Epic-6~~    | Reordered nav items, renamed Console→GameServer, Config→Settings |
